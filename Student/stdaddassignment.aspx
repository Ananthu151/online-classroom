<%@ Page Title="" Language="C#" MasterPageFile="~/Student/stdnavi.Master" AutoEventWireup="true" CodeBehind="stdaddassignment.aspx.cs" Inherits="OnlineClassroom.Student.WebForm14" %>
           ...
           <script type="text/javascript">
               ...
               function sureTo(asaid) {
                   if (confirm("Are you sure you want to delete this assignment?")) {
                       window.location.href = 'stddeleteassignmentanswer.aspx?asaid=' + asaid;
                   }
               }
       ...
       <body>
         <br />
           <center>
                   ...
                   <div class="input1"> 
                    <asp:TextBox ID="TextBox1" runat="server" class="input1" type="file" placeholder="Type your answer..!!" required="true" autocomplete="off"></asp:TextBox>
