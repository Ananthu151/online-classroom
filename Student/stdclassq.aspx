<%@ Page Title="" Language="C#" MasterPageFile="~/Student/stdnavi.Master" AutoEventWireup="true" CodeBehind="stdclassq.aspx.cs" Inherits="OnlineClassroom.Student.WebForm4" %>
           ...
           <asp:DataList ID="DataList1" runat="server">
              ...
              <table>
               ...
               <asp:DataList ID="Data2" runat="server">
                   <ItemTemplate>
                   <div class="study">
                   <div class="part1"><i class="fad fa-edit" id="book"></i>&nbsp&nbsp<p><%#Eval("question") %></p></div>

                       
                   
                   <div class="part2"><a class="comments" href="stdaddanswer.aspx?qid=<%#Eval("qid") %>">Add Answer</a><div id="date"><%#Eval("qdate") %> | Due: <%#Eval("due") %></div></div>
                   </div>
                   </ItemTemplate>
                </asp:DataList>
            </center>                 
