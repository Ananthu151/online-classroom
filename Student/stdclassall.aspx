<%@ Page Title="" Language="C#" MasterPageFile="~/Student/stdnavi.Master" AutoEventWireup="true" CodeBehind="stdclassall.aspx.cs" Inherits="OnlineClassroom.Student.WebForm3" %>
           ...
           <asp:DataList ID="DataList1" runat="server">
              ...
              <table>
               ...
               <asp:DataList ID="Data2" runat="server">
                   ...
                   <div class="part2"><a class="comments" href="stdviewcomments.aspx?mid=<%#Eval("mid") %>">View comments</a><div id="date"><%#Eval("mdate") %></div></div>
                   </div>
                   </ItemTemplate>
                </asp:DataList>
