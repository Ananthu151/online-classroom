<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/thrnavi.Master" AutoEventWireup="true" CodeBehind="thrviewanswers.aspx.cs" Inherits="OnlineClassroom.Teacher.WebForm10" %>
               ...
               <br />
                   ...
                   <ItemTemplate>
                    <div class="cmd">
                        ...
                        <div class="p2"><%#Eval("answer") %><a id="d" href="javascript:sureTo(<%#Eval("ansid") %>)"><i class="fas fa-trash"></i></a></div>
                    </div>
                   </ItemTemplate>
                   </asp:DataList>

               <div class="bar">
                     <div class="bar2" style=" color:grey; border-bottom:2px solid grey;">Not Answered</div>
                    </div>
               <br />
                 ...
                 <asp:DataList ID="Data2" runat="server">
                   <ItemTemplate>
                    <div class="cmd">
                        <div class="p1"><img id="picuser"  src="../images/<%#Eval("simage") %>"/><h5 id="uname44"><a href="thrtochat.aspx?sid=<%#Eval("sid") %>" style="text-decoration:none; color:black;"><%#Eval("sname") %></h5><p id="uname2"></p></div>
