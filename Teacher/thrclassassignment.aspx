<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/thrnavi.Master" AutoEventWireup="true" CodeBehind="WebForm12.aspx.cs" Inherits="OnlineClassroom.Teacher.WebForm12" %>
...
<html>
       <head>
           <script type="text/javascript">
               ...
               function sureTo(asid) {
                   if (confirm("Are you sure you want to delete this question?")) {
                       window.location.href = 'thrdeleteassignment.aspx?asid=' + asid;
                   }
               }
       ...
       <body>
           ...
           <asp:DataList ID="D1" runat="server">
              ...
              <table>
                  ...
                  <tr>
                 <td class="create">
                     <a href="thraddassignment.aspx"><i class="fas fa-plus-circle" style="color:red;"> add assignment</i></a>
                     <div class="triker">
                         <div class="more">
               ...
               <asp:DataList ID="D2" runat="server">
                   <ItemTemplate>
                   <div class="study">
                   <div class="part1"><i class="fas fa-file-edit" id="book"></i>&nbsp&nbsp<p><%#Eval("asquestion") %></p><a id="d" href="javascript:sureTo(<%#Eval("asid") %>)"><i class="fas fa-trash"></i></a></div>

                       
                   
                   <div class="part2"><a class="comments" href="thrviewassignments.aspx?asid=<%#Eval("asid") %>">View Assignments</a><div id="date"><%#Eval("asdate") %>  | Due: <%#Eval("asdue") %></div></div>
                   </div>
                   </ItemTemplate>
                </asp:DataList>
            </center>                 
